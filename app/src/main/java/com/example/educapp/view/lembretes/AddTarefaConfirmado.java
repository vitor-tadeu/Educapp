...
public class AddTarefaConfirmado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_tarefa_confirmado);
        chamaFuncao();
    }
    ...
    public void configuraAdapter() {
        adapter = new TarefaNomeAdapter(AddTarefaConfirmado.this, AddTarefaConfirmado.this, nomes);
    ...
    private void abreLista(TarefaNomeAdapter adapter) {
        adapter.setOnItemClickListener(new TarefaNomeOnItemClickListener() {
            ...
            public void OnItemClick(TarefaNome nome, int posicao) {
                Intent intent = new Intent(AddTarefaConfirmado.this, EditarEvento.class);
