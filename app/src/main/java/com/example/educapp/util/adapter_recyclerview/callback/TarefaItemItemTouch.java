...
public class TarefaItemItemTouch extends ItemTouchHelper.Callback {
    private TarefaItemCallback callback;

    public TarefaItemItemTouch(TarefaItemCallback callback) {
    ...
    public interface TarefaItemCallback {
