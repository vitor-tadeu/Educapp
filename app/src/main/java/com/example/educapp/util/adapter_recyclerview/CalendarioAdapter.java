...
public class CalendarioAdapter extends RecyclerView.Adapter<CalendarioAdapter.CalendarioViewHolder> implements Filterable{
    private final Context context;
    private final Activity activity;
    private final List<CriarEvento> eventos;
    private final List<CriarEvento> eventosFull;
    private CalendarioOnItemClickListener onItemClickListener;

    public CalendarioAdapter(Context context, Activity activity, List<CriarEvento> eventos) {
    ...
    public void setOnItemClickListener(CalendarioOnItemClickListener onItemClickListener) {
    ...
    class CalendarioViewHolder extends RecyclerView.ViewHolder {
        ...
        private CalendarioViewHolder(View itemView) {
            super(itemView);
